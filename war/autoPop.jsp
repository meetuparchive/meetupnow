...
String[][] descs = {
	{"Let's be good samaritans and help people out for a change!\nAll you need to spare is a little bit of time","Be nice to other people! Giving back is good! Meet up around the flag pole and we will split up into teams to go make a difference in people's lives."},
	...
	{"We're having a kegger tonight at Delta Alpha Pi, so come by and get wasted tonight!  $5 per head to cover brews, and PLEASE PLEASE PLEASE carpool. 21 and up only, we WILL be checking.","I'm having a Harry Potter themed party at my house tonight, so come dressed up as harry, ron, hermione, or your favorite other character.  NO MUGGLES ALLOWED :)"},
	{"Hey, I'm new in town and kinda want to see whats up here.  If your new too and want to join, or you're a native and feel like showing us around, join up!", "I'm leading a trip to this historical site later, and wouldn't mind bringing along a few more. If you are interested, sign up!!"},
	{"We're trying to get a pickup game going later, (we already have 5, but the more the merrier), so bring your skills to the field later and we'll see what you got! (PS we arent that good, so don't be afraid)", "Trying to get a game together... Im feeling aggressive and am in the mood for some good old fashioned team sports.  I'm open to suggestions, but lets meet up and get something going!"},
	...
	{"There is a twilight zone marathon on tonight! Who wants to get some popcorn and watch for 12 straight hours? I DO!!!!!!!! ","Lets all go to see the new Star Trek movie dressed in starfleet uniforms. I have a bunch so anyone who wants to borrow one lmk"}
};

String[][] names = {
	{"Helping People","Doing Good Deeds", "Being a good samaritan","Awesome ways to feel good about yourself"},
	{"Lets get a meal","I'm Hungry", "Food anyone?", "STARRRVING"},
	{"Computer Game Tourny!","Computer party!", "Lets start a Horde!!","NEED MORE NERDS"},
	{"Running with Strangers","Exersize is good for you","Climbing the hill","Work those glutes"},
